    ...
    <div class="w-full relative overflow-hidden">
      ...
      >
        ...
        <img
          ...
          class="absolute right-0 bottom-0 md:top-0 translate-x-1/4 translate-y-[60%] md:translate-y-[10%] lg:translate-y-0 object-cover z-10 w-[120%] md:w-full"
          aria-hidden="true"
        />
        ...
        <div class="relative z-10 flex flex-col gap-y-14 md:gap-y-8 md:w-2/3">
          <header class="space-y-4 md:space-y-6">
            ...
            >
              Upload your PDF and instantly transform it into a sleek,
